...
StartGameView.prototype.init = function()
{
	...
	startbtn.x = backWidth*0.5 - startbtnBitmap.getWidth()*0.5;
...
{
	var s=this;
	var startbtnBitmap = new LBitmap(new LBitmapData(imgList["startBtn1"]))
	
	startbtn1 = new LButton(startbtnBitmap,null)
	s.addChild(startbtn1)
	startbtn1.x = backWidth*0.5 - startbtnBitmap.getWidth()*0.5;
	startbtn1.y = 850;
